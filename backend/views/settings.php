							...
							<div id="settings_site" class="tab-pane show active" role="tabpanel">
								<div class="row">
									<div class="col-md-6 col-lg-4">
										...
										<input type="text" class="form-control" name="settings[sitename]" value="<?php echo htmlentities($app->getSetting("sitename")); ?>" required />
										<label for="settings[site_desc]">Site Description:</label>
										<input type="text" class="form-control" name="settings[site_desc]" value="<?php echo htmlentities($app->getSetting("site_desc")); ?>" required />
										<label for="settings[charset]">Character Set:</label>
										<input type="text" class="form-control" name="settings[charset]" value="<?php echo htmlentities($app->getSetting("charset")); ?>" required />
										<label for="settings[date_format]">Short Date Format:</label>
										<input type="text" class="form-control" name="settings[date_format]" value="<?php echo htmlentities($app->getSetting("date_format")); ?>" required />
										<label for="settings[date_format_long]">Long Date Format:</label>
										<input type="text" class="form-control" name="settings[date_format_long]" value="<?php echo htmlentities($app->getSetting("date_format_long")); ?>" required />
										<label for="settings[time_format]">Short Time Format:</label>
										<input type="text" class="form-control" name="settings[time_format]" value="<?php echo htmlentities($app->getSetting("time_format")); ?>" required />
										<label for="settings[time_format_long]">Long Time Format:</label>
										<input type="text" class="form-control" name="settings[time_format_long]" value="<?php echo htmlentities($app->getSetting("time_format_long")); ?>" required />
									</div>
								</div>
							</div>
							<div id="settings_seo" class="tab-pane" role="tabpanel">
								<div class="row">
									<div class="col-md-6 col-lg-4">
										...
										<textarea class="form-control" name="settings[meta_desc]" required><?php echo htmlentities($app->getSetting("meta_desc")); ?></textarea>
										<label for="settings[meta_keys]">Default Meta Keywords:</label>
										<textarea class="form-control" name="settings[meta_keys]" required><?php echo htmlentities($app->getSetting("meta_keys")); ?></textarea>
										<label for="settings[meta_robots]">Default Meta Robots:</label>
										<input type="text" class="form-control" name="settings[meta_robots]" value="<?php echo htmlentities($app->getSetting("meta_robots")); ?>" required />
									</div>
								</div>
							</div>
							<div id="settings_appearance" class="tab-pane" role="tabpanel">
								<div class="row">
									<div class="col-md-6 col-lg-4">
										...
										<input type="text" class="form-control" name="settings[logopath]" value="<?php echo htmlentities($app->getSetting("logopath")); ?>" required />
										...
										<input type="text" class="form-control" name="settings[template]" value="<?php echo htmlentities($app->getSetting("template")); ?>" required />
										<label for="settings[backend_template]">Backend Template:</label>
										<input type="text" class="form-control" name="settings[backend_template]" value="<?php echo htmlentities($app->getSetting("backend_template")); ?>" required />
									</div>
								</div>
							</div>
							...
							<div id="settings_users" class="tab-pane" role="tabpanel">
								<div class="row">
									<div class="col-md-6 col-lg-4">
										...
										<?php RenderHelper::renderUserGroupPicker("settings[users.default_group]", $app->getSetting("users.default_group")); ?>
										<label for="settings[users.password_min]">Minimum Password Length:</label>
										<input type="number" class="form-control" name="settings[users.password_min]" value="<?php echo htmlentities($app->getSetting("users.password_min")); ?>" required />
										<label for="settings[users.password_min_letters]">Minimum Letters in Password:</label>
										<input type="number" class="form-control" name="settings[users.password_min_letters]" value="<?php echo htmlentities($app->getSetting("users.password_min_letters")); ?>" required />
										<label for="settings[users.password_min_numbers]">Minimum Numbers in Password:</label>
										<input type="number" class="form-control" name="settings[users.password_min_numbers]" value="<?php echo htmlentities($app->getSetting("users.password_min_numbers")); ?>" required />
										<label for="settings[users.password_min_special]">Minimum Special Characters in Password:</label>
										<input type="number" class="form-control" name="settings[users.password_min_special]" value="<?php echo htmlentities($app->getSetting("users.password_min_special")); ?>" required />
										<label for="settings[users.session_timeout]">Session Timeout (Seconds):</label>
										<input type="number" class="form-control" name="settings[users.session_timeout]" value="<?php echo htmlentities($app->getSetting("users.session_timeout")); ?>" required />
									</div>
								</div>
							</div>
							<div id="settings_mail" class="tab-pane" role="tabpanel">
								<div class="row">
									<div class="col-md-6 col-lg-4">
										...
										<input type="text" class="form-control" name="settings[mail.hostname]" value="<?php echo htmlentities($app->getSetting("mail.hostname")); ?>" required />
										<label for="settings[mail.port]">Mail server port:</label>
										<input type="number" class="form-control" name="settings[mail.port]" value="<?php echo htmlentities($app->getSetting("mail.port")); ?>" required />
										<label for="settings[mail.from]">From address:</label>
										<input type="email" class="form-control" name="settings[mail.from]" value="<?php echo htmlentities($app->getSetting("mail.from")); ?>" required />
