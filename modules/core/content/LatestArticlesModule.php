	...
	*/
	...
	class LatestArticlesModule extends Module {
		public function render() {
			...
			if ($this->settings["filter"]) $articles = $app->content->getArticles($this->settings["filtercat"]);
			...
			echo "<ul class=\"module CustomModule module-$this->id {$this->settings["classes"]}\">\n";
			echo "<h3>$this->title</h3>";

			for ($i = 0; $i < $this->settings["numarticles"]; $i++) {
