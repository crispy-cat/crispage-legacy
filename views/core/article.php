<?php
	...
	*/
	...
	if (!$app->vars["article"] || ($app->vars["article"]->state != "published" && (!$session || !\Crispage\Assets\User::userHasPermissions($session->user, \Crispage\Users\UserPermissions::VIEW_UNPUBLISHED))))
